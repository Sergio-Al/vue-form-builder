...
<template>
  <div class="preview-wrapper bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
    ...
    <div class="p-6 pointer-events-none">
      <div v-if="!hasFields" class="text-center py-8 text-gray-400 text-sm">
